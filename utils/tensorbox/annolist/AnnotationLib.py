...
import AnnoList_pb2 as AnnoList_pb2
...
def parseTii(filename):
        ...
        # MA: this must be some really _old code
    assert(False);
    annotations = []
...
def parseIDL(filename):
    ...
    for line in lines:
        ...
        # comment by A.C. this returns an error if an image name contains @, probably it was meant to be used with some video annotation
